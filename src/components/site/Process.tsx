      ...
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <Reveal className="mb-14 max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-brown text-pretty">
            Drag the slider to reveal the same space at the start of construction and on the day
            it was handed over.
          </p>
        </Reveal>
  ...
  return (
    <div>
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-sand select-none">
        ...
        <span className="label absolute left-4 top-4 bg-espresso/80 px-2 py-1 text-cream">
          Before
        </span>
        <span className="label absolute right-4 top-4 bg-cream/90 px-2 py-1 text-espresso">
          After
        </span>
