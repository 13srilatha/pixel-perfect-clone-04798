  ...
  return (
    <article className="group cursor-pointer">
      ...
      <div className="mt-5 flex items-baseline justify-between gap-4">
        <div>
          <p className="label mb-1 text-caramel">
        ...
        <span className="label whitespace-nowrap text-caramel transition-all group-hover:text-espresso">
          View →
        </span>
      </div>
      {feature && (
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-brown text-pretty">
          {project.description}
        </p>
      )}
    </article>
...
function Studio() {
  return (
    <section
      id="studio"
      className="mt-32 grid gap-10 border-t border-sand pt-20 md:grid-cols-12"
    >
      ...
      <Reveal className="md:col-span-6 md:col-start-7" delay={150}>
        <div className="space-y-5 text-lg leading-relaxed text-brown">
          <p>
            {studio.name} is a residential architecture and interior practice rooted in {studio.city}.
            We design for stillness — homes you can sink into, not just look at.
          </p>
          <p>
            Our buildings are made from earth's vocabulary: stone, plaster, walnut, unglazed
            terracotta, raw cotton, brushed brass. We compose them around the way your light moves,
            the way your family gathers, the way a room should feel at six in the morning.
          </p>
