    ...
    <>
      ...
      >
        <span className="relative block h-3 w-6">
          <span
            className={`absolute left-0 top-0 h-px w-full bg-espresso transition-transform duration-300 ${
              open ? "translate-y-[6px] rotate-45" : ""
            }`}
          />
          <span
            className={`absolute left-0 top-[6px] h-px w-full bg-espresso transition-transform duration-300 ${
              open ? "-rotate-45" : ""
            }`}
          />
        </span>
      ...
      <div className="relative mx-auto grid max-w-[1600px] gap-12 px-6 py-12 md:grid-cols-12 md:px-10 md:py-24">
        <div className="md:col-span-8">
          ...
          <p className="mt-10 max-w-xl text-lg leading-relaxed text-brown text-pretty">
            ...
            residential architecture and interior design practice based in {studio.city}. We build
            slowly, with stone, wood, and the kind of light you forget to photograph.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-6">
            ...
            <a
              href="#work"
              className="label inline-flex items-center gap-3 text-espresso underline-offset-4 hover:underline"
            >
              See the Work
            </a>
          </div>
