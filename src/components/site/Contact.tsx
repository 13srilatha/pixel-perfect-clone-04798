        ...
        <div className="grid gap-12 md:grid-cols-12">
          <Reveal className="md:col-span-7">
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-cream/75">
              We take on a small number of residential commissions each year so every home gets
              the attention it deserves. Tell us about your site, your family, your dreams — we'll
              write back within 48 hours.
            </p>
          ...
          <Reveal className="md:col-span-4 md:col-start-9" delay={150}>
              ...
              <div>
                ...
                <dd>
                  <a
                    ...
                    className="font-display text-2xl font-light text-cream hover:text-gold-lt"
                  >
                    {studio.email}
                  </a>
                </dd>
            ...
            <div className="mt-12 border-t border-cream/15 pt-8">
              ...
              >
                <span>
                  <span className="font-display text-xl font-light text-cream block">
                    {studio.instagram}
                  </span>
...
function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent(
      `New project enquiry — ${name || "Website visitor"}`
    );
  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2">
        ...
        <p className="label mt-3 text-cream/40">
          Opens your email app · we reply within 48 hours
        </p>
      </div>
    </form>
  );
